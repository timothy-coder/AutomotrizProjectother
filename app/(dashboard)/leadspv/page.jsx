...
import AssignmentDialogLead from "@/app/components/leadspv/AssignmentDialogLead";
import LeadsTable from "@/app/components/leadspv/LeadsTable";
import VistaPorUsuariosLeads from "@/app/components/leadspv/VistaPorUsuariosLeads";
import VistaPorEtapasLeads from "@/app/components/leadspv/VistaPorEtapasLeads";
  ...
  async function loadData() {
    try {
      ...
      const [leadsRes, usersRes] = await Promise.all([
        fetch("/api/leadspv", { cache: "no-store" }),

// app/(dashboard)/cotizaciones/[id]/resumen/dialogs/EditarRegaloDialog.jsx
...
export function EditarRegaloDialog({
    open,
    onOpenChange,
    regalo,
    onRegaloUpdated,
    ...
    useEffect(() => {
        if (regalo && open) {
            ...
            if (regalo.descuento_porcentaje && parseFloat(regalo.descuento_porcentaje) > 0) {
                descuentoTipo = "porcentaje";
            } else if (regalo.descuento_monto && parseFloat(regalo.descuento_monto) > 0) {
                descuentoTipo = "monto";
            }

            setFormData({
                cantidad: parseInt(regalo.cantidad) || 1,
                descuento_tipo: descuentoTipo,
                descuento_porcentaje: regalo.descuento_porcentaje ? parseFloat(regalo.descuento_porcentaje) : null,
                descuento_monto: regalo.descuento_monto ? parseFloat(regalo.descuento_monto) : null,
    ...
    const calculateTotals = () => {
        ...
        const precioConIgv = parseFloat(regalo.precio_unitario) || 0;
